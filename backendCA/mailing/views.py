...
# SMTP Server - 1
server_1_hostname = "mail.careeranna.com"
server_1_username = "editor@careeranna.com"
server_1_password = "editor@123"
server_1_port = 26
...
def send_mail(server="server1", subject=None,to_email=None,from_email=None,content=None,attachment1 = None,filename1 = "Attachment 1", attachment2= None, filename2 = "Attachment 2"):
        # toaddr = to_email
...
def send_password_reset_email(name,email,secret_string):
    link = "https://www.careeranna.com/testengine/adminpanel/passreset/" + secret_string + '/'
