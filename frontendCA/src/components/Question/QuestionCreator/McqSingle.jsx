...
const emptyCorrectAnswer = { 'answer': '' }
...
class McqSingle extends Component {
    constructor(props) {
        super(props);
        ...
        if(editQuestion){
            this.state = {
                ...
                optionHTML: editQuestion.answer_options ? editQuestion.answer_options : emptyOptionDict,
                numOptions: editQuestion.answer_options ? editQuestion.answer_options.options.length : 4,
            ...
            this.state = {
                ...
                optionHTML: editSectionQuestion.answer_options ? editSectionQuestion.answer_options : emptyOptionDict,
                numOptions: editSectionQuestion.answer_options ? editSectionQuestion.answer_options.options.length : 4,
    ...
    handleRemoveOption = event => {
        ...
        this.setState({
            ...
            numOptions: (this.state.numOptions - 1),
            correctAnswer: {
                'answer': correctAnswer > Options.length ? "" : correctAnswer
            }
        })
    ...
    SaveQuestion = (type) => {
        ...
        if (submitCheck){
        console.log(type)
        const optionDict = JSON.stringify(this.state.optionHTML)
        const correctAns = JSON.stringify(this.state.correctAnswer);
...
componentDidMount = () => {
    ...
    render() {
        ...
        renderOptions = [...Array(this.state.numOptions)].map((row, key) => {
            ...
            if(this.state.correctAnswer.answer === String(key+1)){
            ...
            return (
                <div key={key} className="option-mcq-creator">
                    <div className="option-radio-button">
                        <input type="radio" name="option" defaultChecked={isOptionSelected} value={key + 1} />
                    </div>
        ...
        return (
            <Element name="edit-question-div-2" className="question-creator-div">
                ...
                <div>
                    <div className="field-div-2">
                        <span className="field-label">Options : {this.state.numOptions}</span>
                        <form onChange={this.onRadioChange} value={this.state.correctAnswer.answer}>
                            {renderOptions}
                        </form>
                        <div className="option-mcq-add-remove">
