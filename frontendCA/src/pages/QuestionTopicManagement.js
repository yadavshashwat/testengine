...
const deleteConfMessage = "Are you sure you want to delete the question topic? Please note that this will not delete any questions but will remove topics from all assigned questions."
const deleteConfHeader = "Confirm Question Topic Deletion"
      ...
      <BreadcrumbsStateless>{breadCrumbElement}</BreadcrumbsStateless>
        ...
        <ModalTransition>
          {this.state.isModalOpen && (
            ...
            } onClose={this.handleModalClose} height={475} heading={(this.state.isNew ? "Add" : "Edit") + " Question Topic"}>
