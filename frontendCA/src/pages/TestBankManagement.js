...
const deleteConfMessage = "Are you sure you want to delete the test bank. Please note that this will not delete any test just the test bank. Tests will be visible in 'All Tests' section of 'Test Bank' tab";
const deleteConfHeader = "Confirm Test Bank Deletion"

class TestBankManamgement extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
      ...
      cells: [
        {
          ...
          content: <Link to={'/testengine/adminpanel/test-bank/'+row.folder_name+'/'}><div>{row.folder_name}</div></Link>
        },
        {
          key: row.id,
      ...
      <ContentWrapper>
        ...
        <ModalTransition>
          {this.state.isModalOpen && (
            ...
            } onClose={this.handleModalClose} heading={(this.state.isNew ? "Create" : "Edit") + " Test Bank"}>
                    ...
                    <Grid>
                      ...
                      <GridColumn medium={12}>
                        <Field name="description" 
                            ...
                            >
                          {({ fieldProps }) => <TextField  
                          // placeholder="eg. Test database for CAT" 
                          {...fieldProps} />}
                        </Field>
                      </GridColumn>
                    </Grid>
